          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,368px)_1fr_minmax(0,368px)] lg:items-start">
            ...
            <article className="bg-card/95 border-2 border-primary rounded-xl p-4">
              ...
              <p className="text-xs md:text-sm text-foreground leading-relaxed font-medium text-justify">
                ...
                {" "}The facility also contributed to air pollution and greenhouse gas emissions in surrounding communities before its closure in 2018.
                {" "}Because the plant was built before modern environmental laws, many of these impacts occurred without the level of oversight required today. That's exactly why CEQA is so important — it requires projects to disclose impacts, reduce harm, and protect public health before and during development.
                {" "}When Encina was finally shut down, CEQA review helped guide environmental cleanup, mitigation, and redevelopment, ensuring the site addressed long-term damage instead of passing those costs onto the community.
                {" "}Without strong CEQA protections — and with new loopholes for advanced manufacturing — projects could move forward without full environmental review, increasing the risk of long-term damage, higher cleanup costs, and lasting impacts on coastal communities.
              </p>
            </article>
          </div>
