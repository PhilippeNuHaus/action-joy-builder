  ...
  <section className="bg-card py-10 md:py-14">
    <div className="container">
      ...
      <div className="relative overflow-hidden rounded-sm border border-border min-h-[620px]">
        ...
        >
          <polyline
            points="300,150 450,150 500,330"
            fill="none"
            stroke="hsl(var(--navy))"
            strokeWidth="4"
          />
          <polyline
            points="920,500 750,500 530,530"
            fill="none"
            stroke="hsl(var(--navy))"
            strokeWidth="4"
          />
          <circle cx="500" cy="330" r="12" fill="hsl(var(--primary))" stroke="hsl(var(--navy))" strokeWidth="4" />
          <circle cx="530" cy="530" r="12" fill="hsl(var(--primary))" stroke="hsl(var(--navy))" strokeWidth="4" />
        </svg>
