  ...
  <section className="bg-card py-10 md:py-14">
    <div className="container">
      ...
      <div className="relative overflow-hidden rounded-sm border border-border min-h-[620px]">
        ...
        >
          <polyline
            points="300,150 540,150 560,310"
            fill="none"
            stroke="hsl(var(--navy))"
            strokeWidth="4"
          />
          <polyline
            points="920,425 750,425 670,455"
            fill="none"
            stroke="hsl(var(--navy))"
            strokeWidth="4"
          />
          <circle cx="575" cy="315" r="12" fill="hsl(var(--primary))" stroke="hsl(var(--navy))" strokeWidth="4" />
          <circle cx="670" cy="455" r="12" fill="hsl(var(--primary))" stroke="hsl(var(--navy))" strokeWidth="4" />
        </svg>
