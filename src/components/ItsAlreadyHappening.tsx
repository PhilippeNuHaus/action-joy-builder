          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,368px)_1fr_minmax(0,368px)] lg:items-start">
            <article className="bg-card/95 border-2 border-primary rounded-xl p-4">
              ...
              <p className="text-xs md:text-sm text-foreground leading-relaxed font-medium text-justify">
                ...
                storage safety in a seismically active region. With no full <strong>CEQA</strong> process to address the significant negative
            ...
            <article className="bg-card/95 border-2 border-primary rounded-xl p-4">
              ...
              <p className="text-xs md:text-sm text-foreground leading-relaxed font-medium text-justify">
                ...
                {" "}By waiving CEQA for "advanced manufacturing," projects could move forward without full environmental review, increasing the risk of long-term environmental damage and costly cleanup for coastal communities.
              </p>
            </article>
          </div>
