    ...
    <div className="container">
      ...
      <div className="relative overflow-hidden rounded-sm border border-border min-h-[620px]">
        ...
        <div className="relative z-10 p-4 md:p-6 lg:p-8">
          ...
          <div className="grid gap-6 lg:grid-cols-[minmax(0,276px)_1fr_minmax(0,276px)] lg:items-start">
            <article className="bg-card/95 border-2 border-primary rounded-xl p-4">
              ...
              <p className="text-xs md:text-sm text-foreground leading-relaxed font-medium text-left">
                ...
                storage safety in a seismically active region. Large-scale
                industrial projects can leave behind consequences that persist for decades, and without strong environmental
                oversight, communities risk being exposed to long-term hazards.
              </p>
            </article>
