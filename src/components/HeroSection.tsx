  ...
  <section className="relative overflow-hidden">
    ...
    <div className="relative z-10 container py-16 md:py-28">
      <div className="max-w-3xl mx-auto text-center bg-background/40 backdrop-blur-sm rounded-lg p-8 md:p-12">
        ...
        <h1 className="font-heading text-2xl md:text-4xl lg:text-[2.8rem] font-bold uppercase leading-[1.25] mb-4">
          Thank Senator Catherine Blakespear for Protecting Your{" "}
