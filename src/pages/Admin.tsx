...
import { Lock, Users, Sparkles, BarChart3, RefreshCw, MapPin, DollarSign } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0f1923] text-white p-4 md:p-8 max-w-5xl mx-auto space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="bg-[#162029] border border-[#1e2d3a]">
          ...
          <TabsTrigger value="costs" className="data-[state=active]:bg-[#d4a843] data-[state=active]:text-[#0f1923]">
        ...
        <TabsContent value="costs" className="mt-4">
          <CostsTab password={savedPassword} />
        </TabsContent>
